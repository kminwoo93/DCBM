...
# 12 "i2c.c" 2
# 54 "i2c.c"
static __attribute__((inline)) void i2c_clear_interrupt_flag(void)
{
    PIR1bits.SSP1IF = 0U;
}
...
void i2c_init(void)
{
    ...
    SSP1ADD = (uint8_t)((((32000000UL) / (4UL * (100000UL))) - 1UL) & 0xFFUL);

    SSP1STAT = 0b10000000U;
    SSP1CON1 = 0b00101000U;
    SSP1CON2 = 0b00000000U;
