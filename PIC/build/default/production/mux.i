...
# 11 "mux.c" 2
# 62 "mux.c"
static __attribute__((inline)) void mux_write_address(uint8_t address)
{
    uint8_t masked_address = address & ((1U << (3U)) - 1U);

    LATBbits.LATB2 = (masked_address >> (0U)) & (0x01U);
    LATBbits.LATB3 = (masked_address >> (1U)) & (0x01U);
    LATBbits.LATB4 = (masked_address >> (2U)) & (0x01U);
}
...
void mux_select(uint8_t channel)
{
    ...
    uint8_t address = (uint8_t)(channel - (1U));
